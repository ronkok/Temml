let defineFunction,ordargument,mathMLTree,wrapWithMstyle,assertNodeType,ParseError,mml;_a19‍.x([["colorFromSpec",()=>colorFromSpec],["validateColor",()=>validateColor]]);_a19‍.w("../defineFunction",[["default",["defineFunction"],function(v){defineFunction=v}],["ordargument",["ordargument"],function(v){ordargument=v}]]);_a19‍.w("../mathMLTree",[["default",["mathMLTree"],function(v){mathMLTree=v}],["wrapWithMstyle",["wrapWithMstyle"],function(v){wrapWithMstyle=v}]]);_a19‍.w("../parseNode",[["assertNodeType",["assertNodeType"],function(v){assertNodeType=v}]]);_a19‍.w("../ParseError",[["default",["ParseError"],function(v){ParseError=v}]]);_a19‍.w("../buildMathML",[["*",null,function(v){mml=v}]]);
