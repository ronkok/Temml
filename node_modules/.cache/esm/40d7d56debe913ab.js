let defineFunction,normalizeArgument,mathMLTree,StyleLevel,assertNodeType,assert,mml,calculateSize;_ebe‍.w("../defineFunction",[["default",["defineFunction"],function(v){defineFunction=v}],["normalizeArgument",["normalizeArgument"],function(v){normalizeArgument=v}]]);_ebe‍.w("../mathMLTree",[["default",["mathMLTree"],function(v){mathMLTree=v}]]);_ebe‍.w("../constants",[["StyleLevel",["StyleLevel"],function(v){StyleLevel=v}]]);_ebe‍.w("../parseNode",[["assertNodeType",["assertNodeType"],function(v){assertNodeType=v}]]);_ebe‍.w("../utils",[["assert",["assert"],function(v){assert=v}]]);_ebe‍.w("../buildMathML",[["*",null,function(v){mml=v}]]);_ebe‍.w("../units",[["calculateSize",["calculateSize"],function(v){calculateSize=v}]]);
