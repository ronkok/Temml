let defineFunction,mathMLTree,calculateSize,assertNodeType,ParseError;_ebe‍.x([["spaceCharacter",()=>spaceCharacter]]);_ebe‍.w("../defineFunction",[["default",["defineFunction"],function(v){defineFunction=v}]]);_ebe‍.w("../mathMLTree",[["default",["mathMLTree"],function(v){mathMLTree=v}]]);_ebe‍.w("../units",[["calculateSize",["calculateSize"],function(v){calculateSize=v}]]);_ebe‍.w("../parseNode",[["assertNodeType",["assertNodeType"],function(v){assertNodeType=v}]]);_ebe‍.w("../ParseError",[["default",["ParseError"],function(v){ParseError=v}]]);// Horizontal spacing commands
