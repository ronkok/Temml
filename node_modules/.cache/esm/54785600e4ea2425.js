let temml,ParseError,parseTree,Settings;_e4e‍.w("../utils/temml.cjs",[["default",["temml"],function(v){temml=v}]]);_e4e‍.w("../src/ParseError",[["default",["ParseError"],function(v){ParseError=v}]]);_e4e‍.w("../src/parseTree",[["default",["parseTree"],function(v){parseTree=v}]]);_e4e‍.w("../src/Settings",[["default",["Settings"],function(v){Settings=v}]]); // includess mhchem & physics extensions
...
const test = () => {
  ...
  const say = problem => {
    numFailures += 1
    _e4e‍.g.console.log(assertion + ", but " + problem)
    console.log("")
  }
  ...
  _e4e‍.g.console.log("Number of tests:    " + numTests)
  _e4e‍.g.console.log("Number of failures: " + numFailures)
}
