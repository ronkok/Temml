...
+--------------------------+---------------------------+-------------------------+-------------------------+
| $*$  `*`                 | $\circledast$             | $\leftmodels$           | $\rightthreetimes$      |
|                          | `\circledast`             | `\leftmodels`           | `\rightthreetimes`      |
+--------------------------+---------------------------+-------------------------+-------------------------+
| $\amalg$  `\amalg`       | $\circledcirc$            | $\ldotp$  `\ldotp`      | $\rtimes$  `\rtimes`    |
|                          | `\circledcirc`            |                         |                         |
+--------------------------+---------------------------+-------------------------+-------------------------+
| $\And$  `\And`           | $\circleddash$            | $\lor$  `\lor`          | $\setminus$ `\setminus` |
|                          | `\circleddash`            |                         |                         |
+--------------------------+---------------------------+-------------------------+-------------------------+
| $\ast$  `\ast`           | $\Cup$  `\Cup`            | $\lessdot$  `\lessdot`  | $\smallsetminus$        |
|                          |                           |                         | `\smallsetminus`        |
+--------------------------+---------------------------+-------------------------+-------------------------+
| $\barwedge$ `\barwedge`  | $\cup$  `\cup`            | $\lhd$  `\lhd`          | $\sqcap$  `\sqcap`      |
+--------------------------+---------------------------+-------------------------+-------------------------+
| $\bigcirc$  `\bigcirc`   | $\curlyvee$ `\curlyvee`   | $\ltimes$  `\ltimes`    | $\sqcup$  `\sqcup`      |
+--------------------------+---------------------------+-------------------------+-------------------------+
| $\bmod$  `\bmod`         | $\curlywedge$             | $x \mod a$  `x\mod a`   | $\sslash$  `\sslash`    |
|                          | `\curlywedge`             |                         |                         |
+--------------------------+---------------------------+-------------------------+-------------------------+
| $\bowtie$  `\bowtie` or\ | $\div$  `\div`            | $\mp$  `\mp`            | $\times$  `\times`      |
|  `\Join`                 |                           |                         |                         |
+--------------------------+---------------------------+-------------------------+-------------------------+
