...
+---------------------------+------------------------+--------------------------------+--------------------+
| $` \arctan ` `\arctan`    | $` \cotg ` `\cotg`     | $` \ker ` `\ker`               | $` \sinh ` `\sinh` |
+---------------------------+------------------------+--------------------------------+--------------------+
| $` \arctg ` `\arctg`      | $` \coth ` `\coth`     | $` \lg ` `\lg`                 | $` \sh ` `\sh`     |
+---------------------------+------------------------+--------------------------------+--------------------+
| $` \arcctg ` `\arcctg`    | $` \csc ` `\csc`       | $` \ln ` `\ln`                 | $` \tan ` `\tan`   |
+---------------------------+------------------------+--------------------------------+--------------------+
| $` \arg ` `\arg`          | $` \ctg ` `\ctg`       |  $` \log ` `\log`              | $` \tanh ` `\tanh` |
+---------------------------+------------------------+--------------------------------+--------------------+
| $` \ch ` `\ch`            | $` \cth ` `\cth`       | $`\odv{f}{x}` `\odv{f}{x}`     | $` \tg ` `\tg`     |
+---------------------------+------------------------+--------------------------------+--------------------+
| $` \cos ` `\cos`          | $` \nabla ` `\nabla`   | $`\odv*{f}{x}` `\odv*{f}{x}`   | $` \th ` `\th`     |
+---------------------------+------------------------+--------------------------------+--------------------+
| $` \partial ` `\partial`  | $` \deg ` `\deg`       | $`\pdv{f}{x,y}` `\pdv{f}{x,y}` |                    |
+---------------------------+------------------------+--------------------------------+--------------------+
