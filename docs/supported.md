...
+----------------------+--------------------------+----------------------------+-------------------------------+
| $\intbar$  `\intbar` | $\intBar$  `\intBar`     | $\fint$  `\fint`           | $\bigtimes$ `\bigtimes`       |
+----------------------+--------------------------+----------------------------+-------------------------------+
...
+--------------------------+---------------------------+------------------------+-------------------------+
| $-$  `-`                 | $\centerdot$ `\centerdot` | $\leftthreetimes$      | $\rhd$  `\rhd`          |
|                          |                           | `\leftthreetimes`      |                         |
+--------------------------+---------------------------+------------------------+-------------------------+
...
+--------------------------+---------------------------+------------------------+-------------------------+
| $\bmod$  `\bmod`         | $\curlywedge$             | $\mp$  `\mp`           | $\sslash$  `\sslash`    |
|                          | `\curlywedge`             |                        |                         |
+--------------------------+---------------------------+------------------------+-------------------------+
| $\bowtie$  `\bowtie` or\ | $\div$  `\div`            | $\odot$  `\odot`       | $\times$  `\times`      |
|  `\Join`                 |                           |                        |                         |
+--------------------------+---------------------------+------------------------+-------------------------+
| $\boxdot$   `\boxdot`    | $\divideontimes$          | $\ominus$  `\ominus`   | $\unlhd$  `\unlhd`      |
|                          | `\divideontimes`          |                        |                         |
+--------------------------+---------------------------+------------------------+-------------------------+
| $\boxminus$ `\boxminus`  | $\dotplus$  `\dotplus`    | $\oplus$  `\oplus`     | $\unrhd$  `\unrhd`      |
+--------------------------+---------------------------+------------------------+-------------------------+
| $\boxplus$  `\boxplus`   | $\doublebarwedge$         | $\otimes$  `\otimes`   | $\uplus$  `\uplus`      |
|                          | `\doublebarwedge`         |                        |                         |
+--------------------------+---------------------------+------------------------+-------------------------+
| $\boxtimes$ `\boxtimes`  | $\doublecap$ `\doublecap` | $\oslash$  `\oslash`   | $\vee$  `\vee`          |
+--------------------------+---------------------------+------------------------+-------------------------+
| $\bullet$   `\bullet`    | $\doublecup$ `\doublecup` | $\parr$   `\parr`      | $\veebar$  `\veebar`    |
+--------------------------+---------------------------+------------------------+-------------------------+
| $\Cap$  `\Cap`           | $\fullouterjoin$          | $\pm$  `\pm`           | $\wedge$  `\wedge`      |
|                          | `\fullouterjoin`          |                        |                         |
+--------------------------+---------------------------+------------------------+-------------------------+
| $\cap$  `\cap`           | $\gtrdot$  `\gtrdot`      | $x \pmod a$            | $\with$   `\with`       |
|                          |                           | `x \pmod a`            |                         |
+--------------------------+---------------------------+------------------------+-------------------------+
| $\cdot$  `\cdot`         | $\intercal$ `\intercal`   |                        | $\wr$  `\wr`            |
+--------------------------+---------------------------+------------------------+-------------------------+
...
$\href{https://temml.org/}{\color{black}\Large\Temml}$   v0.10.21
